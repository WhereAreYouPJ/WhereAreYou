...
object SoundSearcherUtil {
    ...
    private val INITIAL_SOUND = arrayOf('ㄱ', 'ㄲ', 'ㄴ', 'ㄷ', 'ㄸ', 'ㄹ', 'ㅁ', 'ㅂ', 'ㅃ', 'ㅅ', 'ㅆ', 'ㅇ', 'ㅈ', 'ㅉ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ')
    ...
    private fun getInitialSound(c: Char): Char {
        val hanBegin = c.code - HANGUL_BEGIN_UNICODE
        val index = hanBegin / HANGUL_BASE_UNIT
